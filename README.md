...
| --------------------------- | --------: | ------------------------------------------ | ------------------------: | --------------------------------------------------------------------------------------- |
| **Main** (`main`)           | **45–47** | `org.gnome.shell.extensions.numeric-clock` |                   **v15** | **Do not** include `schemas/gschemas.compiled`. Metadata includes `"icon": "icon.png"`. |
