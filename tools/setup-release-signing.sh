...
echo ""
echo "=== GitHub Signing key ==="
echo "For Verified release tags, register the same public key as a Signing key:"
echo "  https://github.com/settings/ssh/new"
cat "$KEY_PUB"
echo ""

TEST_TAG="numeric-sign-test-$(date +%s)"
...
echo ""
echo "Done. Publish with: NUMERIC_RELEASE_YES=1 ./tools/release-publish.sh"
